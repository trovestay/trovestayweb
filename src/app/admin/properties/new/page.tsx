...
export default function AddProperty() {
  ...
  const handleFeatureToggle = (
    ...
    setForm(prev => {
      ...
      if (checked) {
        ...
        return { 
          ...prev, 
          [arrayName]: currentArray.filter(item => item.id !== featureDef.id) 
        };
      }
    });
  };
  ...
  const renderFeatureSection = (
    ...
    const customFeatures = form[arrayName].filter(f => !standardIds.has(f.id));
    const allFeatures = [...features, ...customFeatures.map(f => ({ ...f, icon: FileText }))];
      ...
      <div className={styles.section}>
        ...
        <div className={styles.checkboxGrid}>
          {allFeatures.map(feat => {
            const selectedFeature = form[arrayName].find(f => f.id === feat.id);
        ...
        <div style={{ padding: '0 1.25rem 1.25rem', display: 'flex', gap: '0.5rem' }}>
          <input 
            ...
            style={{ flex: 1, border: '1px solid #e8e8ec', borderRadius: '10px', padding: '0.7rem 0.9rem' }}
            ...
            <div className={styles.fieldFull}>
              ...
              <div style={{ padding: '0 1.25rem 1.25rem' }}>
                <input
                  ...
                  className={styles.input}
                />
                <span className={styles.uploadSubtext} style={{ display: 'block', marginTop: '0.4rem', marginLeft: '0.2rem' }}>
